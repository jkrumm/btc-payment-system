...
export class MerchantComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.merchantService
      ...
      .subscribe(
        (res: HttpResponse<IMerchant[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
        () => this.onError()
      );
  }
  ...
  registerChangeInMerchants(): void {
    this.eventSubscriber = this.eventManager.subscribe('merchantListModification', () => this.loadPage());
  }
  ...
  protected onSuccess(data: IMerchant[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
