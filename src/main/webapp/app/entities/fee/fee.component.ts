...
export class FeeComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.feeService
      ...
      .subscribe(
        (res: HttpResponse<IFee[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
        () => this.onError()
      );
  }
  ...
  registerChangeInFees(): void {
    this.eventSubscriber = this.eventManager.subscribe('feeListModification', () => this.loadPage());
  }
  ...
  protected onSuccess(data: IFee[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
