...
import { ConfidenceComponent } from 'app/entities/confidence/confidence.component';
...
describe('Component Tests', () => {
  describe('Confidence Management Component', () => {
    let comp: ConfidenceComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(ConfidenceComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.confidences && comp.confidences[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
